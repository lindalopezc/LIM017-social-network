...
export const registerModal = () => {
  ...
  const templateM = `<img class = "image-register-modal" src ="../img/enviar.png"><br>
  ...
  close.addEventListener('click', () => contentModal.remove());
  return contentModal;
};
...
export const deletePostConfirm = (idPost) => {
  ...
  const templateM = `<p class="modal-text-delete"> ¿Está segur@ que desea eliminar esta publicación?</p>
